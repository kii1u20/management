...
class SpreadsheetPrinter {
    companion object {
        /**
         * Prints the spreadsheet with both regular cells and calculation cells
         */
        fun printSpreadsheet(docState: DocumentState.ScheduleState) {
            try {
                val job = PrinterJob.getPrinterJob()
                job.setJobName("Schedule Spreadsheet - ${docState.documentName.value}")
                
                val printable = SpreadsheetPrintable(docState)
    ...
    private class SpreadsheetPrintable(private val docState: DocumentState.ScheduleState) : Printable {
